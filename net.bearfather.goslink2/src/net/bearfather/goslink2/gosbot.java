...
public class gosbot {
	...
	public void tele(String plr,int num) throws InterruptedException, IOException{
		if (num==1){TN=GosLink2.TC1;}
		else{TN=GosLink2.TC2;}
		...
		if (GosLink2.TC1.ghost ==1 || GosLink2.TC2.ghost == 1){cmd=cmd+"\n";}
		TN.write(cmd);
	}
	...
	public void enter(String plr,int num) throws InterruptedException, FileNotFoundException, UnsupportedEncodingException{
		...
		if (num==1){TN=GosLink2.TC1;gname=GosLink2.prps("muser1");}
		else{TN=GosLink2.TC2;gname=GosLink2.prps("muser2");}
	...
	public static void enterchk(){
		for (String value:GosLink2.gb.enters){
			...
			if (value.startsWith("1")){
				GosLink2.TC1.write(value.substring(2));
			}
			else{
				GosLink2.TC2.write(value.substring(2));
			}
		}
